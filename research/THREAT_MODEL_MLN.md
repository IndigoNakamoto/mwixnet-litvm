...
| 2026-08-12 | Mixnet vs governance: README **3-mix** / **3-gov** split; hop directory + same-value batch; LitVM/Nostr not on the mix happy path. Product bar is dest-coin appearance, not empty onion queue. |
