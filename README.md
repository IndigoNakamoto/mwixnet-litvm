...
1. **Phase 3-mix (permissioned shuffle, not Scout)** — Copy [`deploy/mixnet.directory.example.json`](deploy/mixnet.directory.example.json), run three **`coinswapd-research`** mixnodes + Tor HS (**no `mlnd`**), `mln-cli route from-directory`, submit without LitVM fields. Playbook: [`research/PHASE_3_OPERATOR_PLAYBOOK.md`](research/PHASE_3_OPERATOR_PLAYBOOK.md) Part B0. Checklist: [`research/PHASE_3_OPERATOR_CHECKLIST.md`](research/PHASE_3_OPERATOR_CHECKLIST.md). **`make phase3-operator-preflight`**. Proof A vs Proof B labels stay distinct. **3-gov** (Nostr / LitVM / `mlnd` ads) stays parked.
...
| [`research/PHASE_3_OPERATOR_PLAYBOOK.md`](research/PHASE_3_OPERATOR_PLAYBOOK.md) | Phase 3 playbook: Part A stub, Part B0 permissioned mixnet (no Scout/`mlnd`), Part B Scout-era Tor |
