...
4. **Phase 3a — MWEB handoff (stub verified 2026-04-03)** — Re-run anytime: [`PHASE_3_MWEB_HANDOFF_SLICE.md`](PHASE_3_MWEB_HANDOFF_SLICE.md), **`./scripts/e2e-mweb-handoff-stub.sh`** or **`E2E_MWEB_FULL=1`** for full CLI path. **Next:** point **`-rpc-url`** at a built [`research/coinswapd/`](research/coinswapd/) listener when ready (operator keys / Neutrino).
