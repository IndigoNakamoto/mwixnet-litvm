...
1. **Live Tor lab (Phase 3 operators)** — Linear playbook: [`research/PHASE_3_OPERATOR_PLAYBOOK.md`](research/PHASE_3_OPERATOR_PLAYBOOK.md). Checklist + preflight: [`research/PHASE_3_OPERATOR_CHECKLIST.md`](research/PHASE_3_OPERATOR_CHECKLIST.md); **`make phase3-operator-preflight`** (Tor + `HTTP_PROXY` / `NO_PROXY` template + optional **`PHASE3_ONION_JSONRPC_URL`**); deep runbook [`research/PHASE_3_TOR_OPERATOR_LAB.md`](research/PHASE_3_TOR_OPERATOR_LAB.md) (`socks5h://` on **coinswapd**, not only `ALL_PROXY`). **Per-box maker setup (macOS):** [`deploy/MAKER_BOX_SETUP.md`](deploy/MAKER_BOX_SETUP.md) + [`scripts/maker-box-up.sh`](scripts/maker-box-up.sh) + [`deploy/tier2.maker-box.env.example`](deploy/tier2.maker-box.env.example). **Curated Nostr relay:** [`research/PHASE_3_TIER2_RELAY.md`](research/PHASE_3_TIER2_RELAY.md). **Tier progression plan:** [`.cursor/plans/2026-04-16-e2e-coinswap-tiered-review.md`](.cursor/plans/2026-04-16-e2e-coinswap-tiered-review.md).
